...
- [ ] **Task 1: Create Redux templates slice and API** (AC: 1, 2, 3, 8, 10)
...
- [ ] **Task 2: Create TemplateLibrary page component** (AC: 1, 2, 3, 4, 9, 10)
...
- [ ] **Task 3: Create filter controls** (AC: 3, 10)
...
- [ ] **Task 4: Create TemplateCard component for card view** (AC: 1, 2, 5, 10)
...
- [ ] **Task 5: Implement template grid layout** (AC: 1, 10)
...
- [ ] **Task 6: Create TemplateDetailModal component** (AC: 6, 10)
...
- [ ] **Task 7: Implement View Details action** (AC: 6, 10)
...
- [ ] **Task 8: Implement Edit action** (AC: 7)
...
- [ ] **Task 9: Implement Activate/Deactivate action** (AC: 8, 10)
...
- [ ] **Task 10: Create confirmation dialog component** (AC: 8, 10)
...
- [ ] **Task 11: Add navigation to App.tsx** (AC: 1, 4)
...
- [ ] **Task 12: Write component tests** (AC: 1-10)
